  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-xl p-8 text-center card-shadow">
        <h2 className="text-3xl font-bold gradient-text mb-4">Your Numerology Profile</h2>
        <p className="text-gray-600 mb-2">Generated for: <strong>{formData.name}</strong></p>
        <p className="text-gray-600">Birth Date: <strong>{new Date(formData.birthDate).toLocaleDateString()}</strong></p>
      </div>
      ...
      >
        <h3 className="text-2xl font-bold gradient-text mb-4">Want Deeper Insights?</h3>
        <p className="text-gray-600 mb-6">
          Our expert consultants will contact you soon for a detailed analysis and personalized guidance 
          based on your unique numerology profile.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Button className="orange-gradient text-white hover:orange-gradient-hover">
            Book Consultation
          </Button>
        </div>
      </motion.div>
